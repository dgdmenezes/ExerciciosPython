...
pesoDaPesca = float(input("Digite o peso da pesca em KG: "))

if pesoDaPesca <= 50:
    print(f"Sua pesca deu {pesoDaPesca}, portanto você não vai pagar excesso")
else:
    multa = (pesoDaPesca -50)*4
    print(f"Sua pesca deu {pesoDaPesca}, Gerou um excesso de {pesoDaPesca-50} e você vai pagar uma multa de R${multa}")